...
class TaskController extends Controller implements HasMiddleware
{
    ...
    {
        return [
            new Middleware('roles:' . UserRoleEnum::MANAGER->value, only: ['createProjectTask', 'destroy']),
            new Middleware('roles:' . UserRoleEnum::MANAGER->value . ',' . UserRoleEnum::USER->value, only: ['update']),
        ];
    }
